...
ssh $master "spark-submit --packages ch.cern.sparkmeasure:spark-measure_2.12:0.21 --executor-memory 15g /var/scratch/$USER/DDPS_Assignment_1/pyspark_pagerank.py /var/scratch/$USER/DDPS_Assignment_1/datasets/${2} ${3} ${#node_list[@]}"  