...
ssh $master "cd /var/scratch/$USER/spark && ./bin/spark-submit /var/scratch/$USER/spark/examples/src/main/python/pagerank.py /var/scratch/$USER/DDPS_Assignment_1/datasets/soc-Epinions1.txt 10" 
